...
def linear_search(dest_buttons, keyword):
    result = []
    for button in dest_buttons:
        destination = button.original_text.lower()
...
# Modify the apply_filters function to use linear search for the keyword filter
...
# Modify the update_destination_buttons function to use linear search result
def update_destination_buttons(filtered_destinations, price_filter, rooms_filter):
    # Use linear search for keyword filter
    keyword_result = linear_search(destination_buttons, search_entry.get())

    for button in destination_buttons:
        # Use the original_text attribute for comparison
        destination = button.original_text

        # Check if the destination is in the filtered list and the keyword result
        if destination in filtered_destinations and button in keyword_result:
