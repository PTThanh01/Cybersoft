...
image_paths = {
    "Sân bay": "akf.png",
    "Bệnh viện Chợ Rãy": "dfkr.png",
    "Đại học Sài Gòn": "dhh.png",
    "An Dương Vương": "fbf.png",
    "BHD Star": "fbh.png",
    "Nhà thờ": "fbtur.png",
    "Bảo tàng": "gbg.png",
    "Sân bay": "OIG.png",
    "Ktx Đại học Sài Gòn": "OIG1.png",
    "McDonald's": "OIGee.png",
    "Thảo cầm viên": "rth.png",
    "Dinh Độc Lập": "juu.png",
    "Công viên Tao Đàn": "hph.png",
    "KFC": "jjj.png", 
}
...
scrollable_dest_frame.grid(row=0, column=0, padx=5, pady=5, rowspan=18, columnspan=2, sticky="nsew")
